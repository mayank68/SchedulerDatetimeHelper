...
namespace Helper
{
	...
	public static class DateTimeHelper
	{
		...
		#region Yearly
		public static List<DateRange> FindDateRange_Yearly(bool isEndDate, DateTime startDate, DateTime? endDate, int noOfOccurance, DateTime utnillDate, Frequency frequency,string month,int monthDay)
		{
			try
			{
				List<DateRange> lstDateRange = new List<DateRange>();
				...
				lstFinalDateRange = FilterFrequnecy_Yearly(lstDateRange, frequency,month,monthDay);
				return lstFinalDateRange;
			}
			catch (Exception ex)
			{
		...
		public static List<DateRange> FilterFrequnecy_Yearly(List<DateRange> list, Frequency frequency,string month,int monthDay)
		{
			List<DateRange> lstFinalDateRange = new List<DateRange>();
			int monthNumber = 0;
